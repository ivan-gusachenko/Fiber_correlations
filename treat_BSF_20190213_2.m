path = '/Users/ivangusachenko/DATA/LKB/FIBER_Z_CORRELATION/20190213-STEP_58mm_2';

%% get center drift
load([path '/SP_Z_BF66484.mat'])
...
% load([path '/SP_Z_L_f71334.mat']);
% load([path '/SP_Z_L_s74801.mat']);
sz = size(SPECKLE_s);
...
line([-110 -110], [max(meta_Z_L.Lambda), min(meta_Z_L.Lambda)], 'LineWidth', 2, 'Color', 'r')
line([110 110], [max(meta_Z_L.Lambda), min(meta_Z_L.Lambda)], 'LineWidth', 2, 'Color', 'r')
